...
_G.packer_plugins = {
  ["bufdelete.nvim"] = {
    ...
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/bufdelete.nvim",
    url = "https://github.com/famiu/bufdelete.nvim"
  },
  ["neoscroll.nvim"] = {
    config = { "\27LJ\2\n7\0\0\3\0\3\0\0066\0\0\0'\2\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\nsetup\14neoscroll\frequire\0" },
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/neoscroll.nvim",
  ...
  ["splitjoin.vim"] = {
    ...
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/splitjoin.vim",
  ...
  ["vim-eunuch"] = {
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-eunuch",
    url = "https://github.com/tpope/vim-eunuch"
  },
  ["vim-heritage"] = {
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-heritage",
  ...
  ["vim-pasta"] = {
    ...
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-pasta",
  ...
  ["vim-rooter"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/opt/vim-rooter",
  ...
  ["vim-textobj-user"] = {
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-textobj-user",
    url = "https://github.com/kana/vim-textobj-user"
  },
  ["vim-textobj-xmlattr"] = {
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-textobj-xmlattr",
    url = "https://github.com/whatyouhide/vim-textobj-xmlattr"
  },
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/Users/andrew/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
